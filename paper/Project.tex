...
\appendix
    \section{``Who did what?''}
        \begin{itemize}
        	...
        	\item \emph{Richard}: UX (zoom, pan), serial, and OpenMP in \ref{appendix:mandelbro.cu}; assisted in optimization testing and data collection; PowerPoint; \LaTeX{}.
        \end{itemize}
